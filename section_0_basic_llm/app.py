...
class Section0Handler(BaseHTTPRequestHandler):
    server_version = "Section0HTTP/0.1"
    ...
    def do_POST(self) -> None:
        ...
        try:
            ...
            response = {
                ...
                "reference_qa_id": result.reference_qa_id,
            }
            self._set_headers(200)
...
def main() -> None:
    ...
    args = parse_args()
    server = ThreadingHTTPServer(("127.0.0.1", args.port), Section0Handler)
    print(f"Section 0 backend running at http://127.0.0.1:{args.port}")
